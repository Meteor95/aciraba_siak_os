...
router.post("/kategoridompetdata",masterdataController.kategoridompetdata)
router.post("/jasondaftarbankpencatatanlokal",masterdataController.jasondaftarbankpencatatanlokal)
router.post("/jsonhapusmetodepembayaran",masterdataController.jsonhapusmetodepembayaran)
router.post("/nodesimpaninformasimetodepembayaran",masterdataController.nodesimpaninformasimetodepembayaran)
